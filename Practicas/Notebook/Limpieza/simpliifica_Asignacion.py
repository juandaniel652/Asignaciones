...
for i in range (num) :
    ...
    lista_semanas.append(semana_nueva)
    ...
    print(f"{i}. {por_semana[i - 5]}")

    

    if i == i :  #or i == 1 and por_semana[i - 5] == 2 or i == 2 and por_semana[i - 5] == 3 or i == 3 and por_semana[i - 5] == 4 or i == 4 and por_semana[i - 5] == 5:
