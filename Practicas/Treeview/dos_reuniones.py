...
tree.column("#0", width=180, minwidth=180)  # Columna de encabezado (invisible, pero necesaria)
tree.column("col1", width=220, minwidth=220)
tree.column("col2", width=220, minwidth=220)
tree.column("col3", width=175, minwidth=175)
tree.column("col4", width=175, minwidth=175)
tree.column("col5", width=175, minwidth=175)
tree.column("col6", width=175, minwidth=175)
...
for i in range (num) : 
    ...
    aleatorio = random.sample(lista, 8)
    aleatorio_vigilancia = random.sample(lista_vigilancia, 6)
    tree.insert("", "end", text=f"{monday} - {sunday} {mes_nombre} {anio_nombre}", 
                values= (f"{aleatorio[0]} / {aleatorio[1]}", f"{aleatorio[2]} / {aleatorio[3]}", f"{aleatorio_vigilancia[0]}", f"{aleatorio_vigilancia[1]}", f"{aleatorio_vigilancia[2]}", "Miércoles"))
     
    tree.insert("", "end", text=f"{monday} - {sunday} {mes_nombre} {anio_nombre}", 
                values= (f"{aleatorio[4]} / {aleatorio[5]}", f"{aleatorio[6]} / {aleatorio[7]}", f"{aleatorio_vigilancia[3]}", f"{aleatorio_vigilancia[4]}", f"{aleatorio_vigilancia[5]}", "Sabado"))
